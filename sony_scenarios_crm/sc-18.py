...
class Sc3(Name_Exception):
    ...
    def window_handle(self,driver):
        ...
        driver.find_element_by_xpath("//input[@name='subject']").send_keys("laptop")

        driver.find_element_by_xpath("(//img[@alt='Select'])[4]").click()

        windows = driver.window_handles
        print(windows)
        driver.switch_to_window(windows[1])

        driver.find_element_by_xpath("//a[text()='vtiger']").click()
    ...
    def logout(self, driver):
        ...
        driver.close()
obj = Sc3("msg")
driver = obj.browser_open()
obj.login(driver)
obj.more(driver)
obj.window_handle(driver)
obj.logout(driver)