...
class Sc5(Name_Exception):

    def browser_invoke(self):
    ...
    def purchase_order(self,driver):
        ...
        driver.find_element_by_xpath("//a[text()='Create Purchase Order']").click()
...
obj = Sc5("msg")
driver = obj.browser_invoke()
obj.login(driver)
obj.action(driver)
obj.purchase_order(driver)
obj.logout(driver)